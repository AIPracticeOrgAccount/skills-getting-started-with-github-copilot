...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice drills and play matches with the school soccer team",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Team training, conditioning, and competitive basketball games",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, develop performances, and stage productions",
